...
OrganisationId = Annotated[UUID, Depends(get_current_organisation_id)]
...
@router.get(
    "/payments/{payment_id}/attempts", response_model=list[PaymentAttemptResponse]
)
...
def create_customer_endpoint(
    ...
    return create_new_customer(db=db, organisation_id=organisation_id, request=request)
...
def get_customer_endpoint(
    ...
    return get_customer(db=db, organisation_id=organisation_id, customer_id=customer_id)
