...
def get_organisation_by_id(db: Session, organisation_id: UUID) -> Organisation | None:
    """
...
def get_membership(
    db: Session, user_id: UUID, organisation_id: UUID
...
def update_organisation(db: Session, organisation: Organisation) -> Organisation:
    """
